...
def DB_connection():
    ...
    while a == 0:
        try:
            # File_Location = open("D:\\0 PYTHON EXE SQL CONNECTION & DRIVER PATH\\ageops.net\\Location For Database & Driver.txt", "r")
...
#             return mydb_L2L
#         except pymysql.connect as e:
#             # wx.MessageBox('Error On L2L_connection Function', 'ageops.net', wx.OK | wx.ICON_ERROR)
#             exc_type , exc_obj , exc_tb = sys.exc_info()
#             fname = os.path.split(exc_tb.tb_frame.f_code.co_filename)[1]
#             print("Error ON : " , sys._getframe().f_code.co_name + "--> " + str(e) , "\n" , exc_type , "\n" , fname ,
#                   "\n" , exc_tb.tb_lineno)
...
def create_filename(SegFeild):
    ...
    while a == 0:
        try:
            ...
            if SegFeild[44] != "":
                Bidding_Document = "<a href = " + SegFeild[44] + ">Download</a>"
            else:
                Bidding_Document = '-'

            if SegFeild[42] != "":
                amendment_document = "<a href = " + SegFeild[42] + ">Click Here</a>"
            else:
                amendment_document = '-'

            if SegFeild[43] != "":
                notices_document = "<a href = " + SegFeild[43] + ">Click Here</a>"
            else:
                notices_document = '-'
            ...
            string_Translate_Table = "<table align=\"center\" border=\"1\" style=\"width:95%;border-spacing:0;border-collapse: collapse;border:1px solid #666666; margin-top:5px; margin-bottom:5px;\">" + \
                                     ...
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Bidding Title </td><td style=\"padding:7px;\">" + \
                                     SegFeild[19] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Bidding Number </td><td style=\"padding:7px;\">" + \
                                     SegFeild[13] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Procurement Type </td><td style=\"padding:7px;\">" + \
                                     SegFeild[3] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Procurement Entity </td><td style=\"padding:7px;\">" + \
                                     SegFeild[12] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Procurement Method </td><td style=\"padding:7px;\">" + \
                                     SegFeild[4] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Procurement Announcement Date </td><td style=\"padding:7px;\">" + \
                                     SegFeild[5] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Bid Submission Deadline </td><td style=\"padding:7px;\">" + \
                                     SegFeild[24] + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Bidding Document Download </td><td style=\"padding:7px;\">" + \
                                     "" + Bidding_Document + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Amendment Documents </td><td style=\"padding:7px;\">" + \
                                     "" + amendment_document + "</td></tr>" + \
                                     "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Notices Of Tender </td><td style=\"padding:7px;\">" + \
                                     "" + notices_document + "</td></tr></table>"
            Final_HTML_Document = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">" + \
                                  "<head><link rel=\"shortcut icon\" type=\"image/png\" href=\"https://www.tendersontime.com/favicon.ico\"/></head>" + \
                                  "<body>" + string_Translate_Table + "</body></html>"
